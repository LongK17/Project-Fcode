...
{
    printf("Profit after deducting taxes & other expenses:\t\t$%g", afterRevenue);
}
...
int main()
{
    ...
    while(conFlag == 'y')
    {
        ...
        printf("\n7. Delete items");
        printf("\n8. Search items");
        printf("\n9. Product statistics for the week");
        printf("\n10. Revenue report for the week");
        printf("\n11. Revenue reports for the week");
        printf("\n0. Exit\n");
        printf("======================================================================\n");
        printf("\nYour choice:\t ");
        scanf("%d",&key);
